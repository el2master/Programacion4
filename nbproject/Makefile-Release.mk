...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/programacion4

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/programacion4: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/programacion4 ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/Clases/Administrador.o: Clases/Administrador.cpp
	${MKDIR} -p ${OBJECTDIR}/Clases
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/Administrador.o Clases/Administrador.cpp

${OBJECTDIR}/Clases/Apartamento.o: Clases/Apartamento.cpp
	${MKDIR} -p ${OBJECTDIR}/Clases
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/Apartamento.o Clases/Apartamento.cpp

${OBJECTDIR}/Clases/Casa.o: Clases/Casa.cpp
	${MKDIR} -p ${OBJECTDIR}/Clases
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/Casa.o Clases/Casa.cpp

${OBJECTDIR}/Clases/Chat.o: Clases/Chat.cpp
	${MKDIR} -p ${OBJECTDIR}/Clases
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/Chat.o Clases/Chat.cpp

${OBJECTDIR}/Clases/Departamento.o: Clases/Departamento.cpp
	${MKDIR} -p ${OBJECTDIR}/Clases
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/Departamento.o Clases/Departamento.cpp

${OBJECTDIR}/Clases/Edificio.o: Clases/Edificio.cpp
	${MKDIR} -p ${OBJECTDIR}/Clases
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/Edificio.o Clases/Edificio.cpp

${OBJECTDIR}/Clases/Inmobiliaria.o: Clases/Inmobiliaria.cpp
	${MKDIR} -p ${OBJECTDIR}/Clases
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/Inmobiliaria.o Clases/Inmobiliaria.cpp

${OBJECTDIR}/Clases/Interesado.o: Clases/Interesado.cpp
	${MKDIR} -p ${OBJECTDIR}/Clases
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/Interesado.o Clases/Interesado.cpp
...
${OBJECTDIR}/Clases/Propiedad.o: Clases/Propiedad.cpp
	${MKDIR} -p ${OBJECTDIR}/Clases
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/Propiedad.o Clases/Propiedad.cpp
...
${OBJECTDIR}/Clases/Zona.o: Clases/Zona.cpp
	${MKDIR} -p ${OBJECTDIR}/Clases
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/Zona.o Clases/Zona.cpp

${OBJECTDIR}/DataTypes/Fecha.o: DataTypes/Fecha.cpp
	${MKDIR} -p ${OBJECTDIR}/DataTypes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataTypes/Fecha.o DataTypes/Fecha.cpp

${OBJECTDIR}/DataTypes/Hora.o: DataTypes/Hora.cpp
	${MKDIR} -p ${OBJECTDIR}/DataTypes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataTypes/Hora.o DataTypes/Hora.cpp
